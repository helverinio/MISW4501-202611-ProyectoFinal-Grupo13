"""
Contexto compartido para los scripts de benchmark ASR Sprint 1.

Autentica contra producción, descubre los IDs reales de recursos
(hotel, habitación, país, estado) y provee utilidades comunes.

Idéntico al conftest de Sprint 2, más el helper print_stats_p99()
necesario para ASR02 (su medida de respuesta es p99 ≤ 200 ms).
