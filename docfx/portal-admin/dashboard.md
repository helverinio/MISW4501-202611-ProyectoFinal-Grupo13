...
- Boton `Export`.
- Tarjetas KPI como `Total Reservations`, `Monthly Revenue`, `Occupancy Rate` y tiempos o alertas operativas.

### Paso a paso

1. Inicie sesion en el portal administrativo.
2. Revise los indicadores principales del periodo.
3. Ajuste el rango de tiempo si requiere otra vista.
4. Exporte la informacion cuando sea necesario.
