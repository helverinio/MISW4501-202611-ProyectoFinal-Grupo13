# Introduccion general a TravelHub

## Que es TravelHub

TravelHub es una plataforma digital de reservas hoteleras que centraliza la busqueda de alojamientos, la creacion de reservas y el seguimiento de estados en distintos canales de atencion.

## Que puede hacer un usuario en la plataforma

Segun el tipo de acceso, un usuario puede:

- Buscar hoteles por destino, fechas y cantidad de huespedes.
- Revisar resultados disponibles.
- Consultar el detalle de una propiedad.
- Seleccionar habitacion o tarifa.
- Crear y confirmar una reserva.
- Consultar reservas activas, pendientes o canceladas.
- Modificar o cancelar reservas cuando la politica lo permita.
- Recibir mensajes, estados o notificaciones.
